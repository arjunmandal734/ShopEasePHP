...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($price) || empty($stock)) {
        ...
        $stmt->bind_param("ssdii", $name, $description, $price, $stock, $image_url);

        if ($stmt->execute()) {
            $message = "Product added successfully!";
            // Clear form fields after successful submission
            $_POST = array(); // This clears all POST data
            header('Location: dashboard.php?message=' . urlencode('Product added successfully!'));
            exit();
        } else {
...
<head>
    ...
    <title>ShopEasePHP - Add Product</title>
